...
/**
 * The project proof structure that helps to query the public signals
 */
export class ProjectProof extends BaseProof {
    readonly idx = {
        stateTreeRoot: 0,
        value: [1, 5],
    }
    ...
    /**
     * @param _publicSignals The public signals of the project proof that can be verified by the prover
    ...
    constructor(
        ...
        ;(this as any).circuit = 'projectProof'
    }
}
