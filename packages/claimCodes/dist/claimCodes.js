...
exports.markClaimCodeAsUsed =
    exports.generateClaimCodes =
    exports.ClaimCodeStatusEnum =
        void 0
...
;(function (ClaimCodeStatusEnum) {
    ...
    ClaimCodeStatusEnum ||
        (exports.ClaimCodeStatusEnum = ClaimCodeStatusEnum = {})
)
function generateRandomClaimCode() {
    return (
        bip39ish_1.default[
            Math.floor(Math.random() * bip39ish_1.default.length)
        ] +
        '-' +
        bip39ish_1.default[
            Math.floor(Math.random() * bip39ish_1.default.length)
...
function markClaimCodeAsUsed(code, claimCodes) {
    ...
    for (
        var _i = 0, claimCodes_1 = claimCodes;
        _i < claimCodes_1.length;
        _i++
    ) {
